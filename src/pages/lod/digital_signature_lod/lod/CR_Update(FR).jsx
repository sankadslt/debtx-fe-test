    ...
    <div className={GlobalStyle.fontPoppins}>
      <div className="min-h-screen p-6">
        <h1 className={`${GlobalStyle.headingLarge} mb-5`}>
          Customer Response for Final Reminder
        </h1>
        <div className="max-w-4xl mx-auto bg-blue-100 p-8 rounded-lg shadow-lg">
          ...
          <div className="flex items-center space-x-6 ml-40">
            <label className="flex items-center cursor-pointer">
              ...
              <span className={`${GlobalStyle.headingSmall} ml-2 `}>
                Dispute
              </span>
            </label>
          ...
          {selectedOption === "dispute" && (
            <div className="mb-6 mt-6">
              ...
              <label
                htmlFor="remark"
                className={`${GlobalStyle.remarkTopic} block mb-2 `}
              >
                Remark
              </label>
              <textarea
