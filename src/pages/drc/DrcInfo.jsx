              ...
              <table className={`${GlobalStyle.table} table-auto`}>
                ...
                <tbody>
                  {services?.map((service, index) => (
                    ...
                    >
                      <td className={GlobalStyle.tableData}>{service?.service_type}</td>
                      <td className={GlobalStyle.tableData}>1/1/2025</td>
                      <td className={`${GlobalStyle.tableData} flex justify-center`}>
                        <div className="flex items-center justify-center gap-2">
                          <img
                            src={service?.drc_service_status === "Active" ? activeIcon : deactiveIcon}
                            alt={service?.drc_service_status}
                            className="w-5 h-5"
                            title={
                              service?.drc_service_status === "Active" ? "Active" : "Deactive"
                            }
                          />
                        </div>
                      </td>
                    ...
                    {paginatedLogHistory.length > 0 ? (
                      paginatedLogHistory.map((remark, index) => (
                        ...
                        >
                          ...
                          <td className={GlobalStyle.tableData}>{remark?.remark}</td>
                          <td className={GlobalStyle.tableData}>{remark?.remark_edit_by}</td>
                        </tr>
                      ))
                    ) : (
                      <tr>
