...
//         setCheckboxStatus(
//           data.ro_status.length > 0 &&
//             data.ro_status[data.ro_status.length - 1].status === "Active"
//         );
...
//               id: item.rtom_id,
//               name: item.name,
//               changeOn: lastStatus ? new Date(lastStatus.rtoms_for_ro_status_date).toLocaleDateString() : "",
//               enabled: lastStatus ? lastStatus.status === "Active" : false,
//               isNew: false,
//             };
//           })
//         );
...
//     try {
//       const updatedRTOMs = services.filter(
//         (service) => service.isNew || service.enabled !== service.previousEnabled
//       );
...
//         },
//         rtoms_for_ro: updatedRTOMs.map((service) => ({
//           rtom_id: service.id,
